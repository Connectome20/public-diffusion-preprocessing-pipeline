...
%
%
%  [Alpha_x, Alpha_y, Alpha_z, Beta_x, Beta_y, Beta_z, R0] = mris_gradient_nonlin__read_siemens_coeff('coeff_X.grad');
...
%MRIS_GRADIENT_NONLIN__SIEMENS_LEGENDRE  normalize Legendre polynomial with Siemens's convention
  ...
  %************************************************************************%
  %%% $Source: /space/repo/1/dev/dev/gradient_nonlin_unwarp/mris_gradient_nonlin__spharm_evaluate.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
